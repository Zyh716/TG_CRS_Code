...
class TrainLoop():
    def __init__(self, opt, args):
        ...
        self.args.device = "cuda:{}".format(args.gpu) if self.use_cuda else 'cpu'
    ...
    def train(self):
        ...
        for i in range(self.epoch):
            train_loss = []
            # train_topic_losses, train_req_losses, train_rec_losses, train_topic_id_loss = [], [], [], []
            ...
            for batch_idx, batch_data in tqdm(
                ...
                loss = self.model.compute_loss(output, y_type, y_topic_id,
                                               'train')
